...
graph TB
    ...
    subgraph ACTIONS["⚙️ GitHub Actions (CI/CD Pipeline)"]
        ...
        TF_DEV["🚀 Terraform (DEV)<br/>-state=dev.tfvars<br/>spring_profile=dev"]
        TF_PROD["🚀 Terraform (PROD)<br/>-state=default<br/>spring_profile=prod"]
    end
    ...
    TF_DEV -->|2. Despliega e inyecta user-data| EC2_DEV
    ...
    TF_PROD -->|2. Despliega e inyecta user-data| EC2_PROD
